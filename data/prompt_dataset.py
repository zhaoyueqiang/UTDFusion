...
class PromptDataSet_mutli(Dataset):
    def __init__(self,train_multDegOfOne_path_list,val_multDegOfOne_path_list,phase="train", transform=None):
        self.phase = phase
        if phase == "train":
            self.paths = {

                'multDegOfOne_A': train_multDegOfOne_path_list[0],
                'multDegOfOne_B': train_multDegOfOne_path_list[1],
            }
            self.paths_gt = {

                'multDegOfOne_A_gt': train_multDegOfOne_path_list[2],
                'multDegOfOne_B_gt': train_multDegOfOne_path_list[3],
            }
        else:
            self.paths = {

                'multDegOfOne_A': val_multDegOfOne_path_list[0],
                'multDegOfOne_B': val_multDegOfOne_path_list[1],

            }
            self.paths_gt = {

                'multDegOfOne_A_gt': val_multDegOfOne_path_list[0],
                'multDegOfOne_B_gt': val_multDegOfOne_path_list[1],
            }
        self.transform = transform
